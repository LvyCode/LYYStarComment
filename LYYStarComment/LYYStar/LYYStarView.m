...
#define WHITE_NAME @"star_white"
#define RED_NAME @"star_red"

@interface LYYStarView ()

@property(nonatomic,assign)LYYStarType      starType;
...
@implementation LYYStarView

- (instancetype)initWithFrame:(CGRect)frame starSize:(CGSize)starSize withStyle:(LYYStarType)style
{
...
- (void)initView
{
    ...
    if (self.starType == LYYStarTypeInteger)
    {
        for (int i = 0; i < 5; i++)
        {
